...
using CH.Project.MultiTenancy;
using CH.Project.Web.Menus;
    ...
    public class ProjectWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CH.Project.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CH.Project.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CH.Project.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CH.Project.Application"));
